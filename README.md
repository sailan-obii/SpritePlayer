...
- **Configuration de la feuille** :
  - orientation **horizontale** (frames côte à côte), **verticale** (empilées) ou **grille** (colonnes × rangées, lecture gauche → droite puis rangée suivante) ;
...
3. Indique l’**orientation** de la feuille (bande ou grille) et le **nombre d’images** (ou colonnes / rangées en mode grille).
